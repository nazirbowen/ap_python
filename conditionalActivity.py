...
Parameters are the placeholders in our functions definitions. 
Arguments are the actual data we pass into our function when we call it. 

# 2. In your own words, describe what 
# a conditional statement (if/else) is 
A conditional statment is a true or false almost like a boolean
